...
class KeywordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create keyword" do
    assert_difference("Keyword.count") do
      post keywords_url, params: { keyword: { description: @keyword.description, project_id: @keyword.project_id } }, as: :json
    end
  ...
  test "should update keyword" do
    patch keyword_url(@keyword), params: { keyword: { description: @keyword.description, project_id: @keyword.project_id } }, as: :json
    assert_response :success
  end
